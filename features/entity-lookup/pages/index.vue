        ...
        <v-row class="fill-height ma-0">
            <v-col cols="12" class="pa-2 fill-height">
                <div class="feature-wrapper">
                    <FeatureHeader title="Entity Lookup" icon="mdi-magnify" />
...
<script setup lang="ts">
    ...
    import type {
        ...
        NamedEntityReport,
    } from '~/composables/useElementalService';
    ...
    const elementalService = useElementalService();
    ...
    const performSearch = async () => {
        ...
        try {
            ...
            searchResults.value = await elementalService.getNEID(params);
    ...
    const viewEntityReport = async (neid: string) => {
        ...
        try {
            ...
            const response = await elementalService.getNamedEntityReport(neid);
